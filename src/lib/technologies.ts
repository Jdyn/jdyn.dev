...
const technologies: Technologies = {
  docker: {
    ...
    icon: '/assets/images/technologies/docker.svg'
  },
  django: {
    name: 'Django',
    href: '',
    icon: '/assets/images/technologies/django.svg',
    overview:
  ...
  ios: {
    ...
    icon: '/assets/images/technologies/ios.svg'
  },
  css: {
    name: 'CSS',
    ...
    icon: '/assets/images/technologies/css.svg'
  },
  phoenix: {
    name: 'Phoenix',
    ...
    icon: '/assets/images/technologies/phoenix.svg'
  },
  react: {
    name: 'React.js',
    ...
    icon: '/assets/images/technologies/react.svg'
  },
  redux: {
    name: 'Redux.js',
    href: 'https://redux.js.org/',
    overview: '',
    icon: '/assets/images/technologies/redux.svg'
  },
  next: {
    name: 'Next.js',
    href: 'https://nextjs.org/',
    overview: '',
    icon: '/assets/images/technologies/next.svg'
  },
  node: {
    name: 'Node.js',
    ...
    icon: '/assets/images/technologies/nodejs.svg'
  },
  postgres: {
    name: 'PostgreSQL',
    href: 'https://www.postgresql.org/',
    overview: '',
    icon: '/assets/images/technologies/postgresql.svg'
  },
  ec2: {
    name: 'Amazon EC2',
    href: 'https://aws.amazon.com/ec2/',
    overview: '',
    icon: '/assets/images/technologies/ec2.svg'
  },
  rds: {
    name: 'Amazon RDS',
    href: 'https://aws.amazon.com/rds/',
    overview: '',
    icon: '/assets/images/technologies/rds.svg'
  },
  rails: {
    name: 'Ruby on Rails',
    href: 'https://rubyonrails.org/',
    overview: '',
    icon: '/assets/images/technologies/rails.svg'
  },
  nginx: {
    name: 'nginx',
    href: 'https://www.nginx.com/',
    overview: '',
    icon: '/assets/images/technologies/nginx.svg'
  },
  azure: {
    name: 'Azure',
    href: 'https://azure.microsoft.com/en-us/overview/what-is-azure/',
    overview: '',
    icon: '/assets/images/technologies/azure.svg'
  },
  android: {
    name: 'Android',
    href: 'https://developer.android.com/guide/platform',
    overview: '',
    icon: '/assets/images/technologies/android.svg'
  },
  typescript: {
    name: 'TypeScript',
    href: 'https://developer.android.com/guide/platform',
